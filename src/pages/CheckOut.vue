  ...
  <div class="container">
    ...
    <section>
      ...
      <div class="card calendar">
        ...
        <img src="../../public/img/arrow.png" @click="modMonth('add')" v-if="year.length > 1" class="next">
        <img src="../../public/img/arrow.png" @click="modMonth('rem')" v-if="year.length > 1" class="previus">
      </div>
    </section>
    <section v-if="day">
